...
/**
 * Specialist class tester. tests constructor, setters and getters, toString, 
...
public class SpecialistTest {
	...
	private Specialist doctor1, invalidDoctor, anotherInvalidDoctor;
	...
	@Before
	public void setUp() {
		doctor1 = new Specialist("Bobby Bob", 1960, 6, 10, "male",
				"The Quay, Waterford", 12345678, true, "specialist");
		invalidDoctor = new Specialist("AB", 2000, 13, 32, "myself", "here",
				12345, false, "invalid specialist            - namely - too long");
	 ...
	 */
	@Test
	public void testSpecialistConstructor() {
		// valid name
		...
		assertEquals(doctor1.getSpecialist(), "specialist");
		...
		assertNotEquals(invalidDoctor.getSpecialist(), "invalid specialist            - namely - too long");
		assertEquals(invalidDoctor.getSpecialist(), "invalid specialist            ");
		...
		assertNotEquals(anotherInvalidDoctor.getSpecialist(), "invalid specialist            - namely - too long");
		assertEquals(anotherInvalidDoctor.getSpecialist(), "invalid specialist            ");
	}
	...
	public void testSettersAndGetters() {
		...
		// valid specialist
		assertEquals(anotherInvalidDoctor.getSpecialist(), "invalid specialist            ");
		anotherInvalidDoctor.setSpecialist("valid specialist");
		assertNotEquals(anotherInvalidDoctor.getSpecialist(), "invalid specialist            ");
		assertEquals(anotherInvalidDoctor.getSpecialist(), "valid specialist");
		
		// invalid specialist
		assertEquals(invalidDoctor.getSpecialist(), "invalid specialist            ");
		invalidDoctor.setSpecialist("invalid specialist            - namely - too long");
		assertNotEquals(invalidDoctor.getSpecialist(), "invalid specialist            - namely - too long");
		assertEquals(invalidDoctor.getSpecialist(), "invalid specialist            ");
	}
	...
	public void testCalculateRegistrationFee() {
		assertEquals(doctor1.calculateRegistrationFee(), 425, 0.1);
		assertEquals(invalidDoctor.calculateRegistrationFee(), 641, 0.1);
	}
